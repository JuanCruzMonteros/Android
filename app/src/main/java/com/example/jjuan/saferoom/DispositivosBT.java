...
public class DispositivosBT extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.activity_dispositivos_bt);
    }
    ...
    public void onResume()
    {
        ...
        mPairedDevicesArrayAdapter = new ArrayAdapter(this, layout.nombre_dispositivos);//<-<- PARTE A MODIFICAR >->->
        // Presenta los disposisitivos vinculados en el ListView
        IdLista = (ListView) findViewById(id.IdLista);
    ...
    private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView av, View v, int arg2, long arg3) {
            ...
            Intent i = new Intent(DispositivosBT.this, Informacion.class);//<-<- PARTE A MODIFICAR >->->
